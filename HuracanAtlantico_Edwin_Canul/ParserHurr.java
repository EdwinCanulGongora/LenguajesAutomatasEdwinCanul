...
class ParserHurr implements ParserHurrConstants {
        public static void main (String[] args) throws ParseException{
                try {
                    ...
                    System.out.println("Se encontro errores en el codigo");
...
save = arrOcean.image.toString();
                String subString = save.substring(0,2);//subString= "AL"

                String subString2 = save.substring(2,4);//subString2= "01"

        String subString3 = save.substring(4,8);//subString3= "1851"
...
//Fechas
        ...
        //datos de fechas
                String num2 = num1.substring(0,4); //num2= "1851" año

                String num3 = num1.substring(4,6); //num3= "06" mes

                String num4 = num1.substring(6,8); //num4 ="25" día

        //Horas y minutos
                String num5 = divide[1];//obtiendo la lista que contiene la hora "0000"

                String num6 = num5.substring(1,2);//num6= "00"

                String num7 = num5.substring(3,4);//num7= "00"

                save= num2 +","+num3+","+num4+","+num6+","+num7+",";//Formato para acomodar la fecha y hora save= "1851,06,25,00,00,"
...
//longitud del huracán
                ...
                //Condición que verifica si la longitud contiene una W o E para quitarlos
                if(str4.contains("W")){
                        str4=str4.replace("W","");
                }else{
                        str4=str4.replace("E","");
...
//método que ejecuta el programa
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x8000000,0x800000,0x200000,};
   }
